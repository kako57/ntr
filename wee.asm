...
#
# Student: Dre Cura
# Student Number, UTorID, official email not here
#
...
# - https://youtu.be/CC5ar1MOnUs
#
# Are you OK with us sharing the video with people outside course staff?
# - yes (https://github.com/kako57/ntr)
#
...
gdfr:
        ...
        bne $v0, PLATFORM, after_vertical_movement
...
up_key_pressed:
        ...
        beq $t1, 2, after_up_key_pressed # 2 jumps already counted

        addi $t1, $t1, 1
        sw $t1, 0($t2) # 1 jump counted

        la $t2, jumping
        li $t1, 8
        sw $t1, 0($t2) # 8 frames of jumping

after_up_key_pressed:
        li $v0, 0
